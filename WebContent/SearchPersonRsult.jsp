...
<title>Persons search result</title>
</head>
...
<table border="1">
    ...
    <c:forEach var="Person_result" items="${Person_result}">
    <tr>


<td>${Person_result.firstName}</td>
<td>${Person_result.lastName}</td>
<td>${Person_result.relationship}</td>
<td>${Person_result.address}</td>
<td>${Person_result.phone}</td>
<td>${Person_result.email}</td>
<td>${Person_result.comment}</td>
