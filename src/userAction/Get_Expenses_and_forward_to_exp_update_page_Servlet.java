...
/**
 * Servlet implementation class Get_Expenses_and_forward_to_exp_update_page_Servlet
 */
@WebServlet("/Get_Expenses_and_forward_to_exp_update_page")
public class Get_Expenses_and_forward_to_exp_update_page_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Get_Expenses_and_forward_to_exp_update_page_Servlet() {
        super();
